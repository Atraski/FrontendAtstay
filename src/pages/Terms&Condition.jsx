    ...
    <div className="policy-container">
      ...
      <div className=" ">
        ...
        <ol className="policy-list" style={{ marginBottom: "1rem" }}>
          <li>
            <span className="list-heading">Use of Site:</span> You agree to use
            our site for lawful purposes only. You shall not use our site for
            any illegal or unauthorized purposes or engage in any activities
            that could harm or interfere with the operation of our site.
          </li>
          <li>
            <span className="list-heading">Intellectual Property:</span> All
            content, trademarks, and data on our site, including but not limited
            to software, databases, text, graphics, icons, hyperlinks, private
            information, designs, and agreements, are the property of or
            licensed to AtStay and as such are protected from infringement by
            local and international legislation and treaties. Unauthorized use,
            copying, reproduction, modification, republishing, uploading,
          ...
          <li>
            ...
            emails, errors, defects, viruses, delays in operation or
            transmission, or any failure of performance, whether or not
            resulting from acts of God, communications failure, theft,
            destruction, or unauthorized access to AtStay’ records, programs, or
            services. You hereby acknowledge that this paragraph shall apply to
            all content, merchandise, and services available through our site.
          </li>
          <li>
            ...
            personal jurisdiction of the courts located in that jurisdiction for
          ...
          <li>
            ...
            the right to amend these Terms at any time. Any such amendments will
            be effective immediately upon posting on our site. Your continued
            use of the site will be deemed acceptance thereof.
          </li>
          <li>
            <span className="list-heading"> Contact Information:</span> If you
            have any questions or concerns about these Terms, please contact us
            at atstaytravel@gmail.com.
          </li>
        </ol>
      </div>
      <p>
